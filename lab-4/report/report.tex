...
\subsection{json\(_{\text{lib}}\)}
\label{sec:org501f013}
\lstset{language=Python,label= ,caption={\_\(_{\text{init}}\)\_\(_{\text{.py}}\)},captionpos=b,numbers=none}
\begin{lstlisting}
...
\subsection{yaml\(_{\text{lib}}\)}
\label{sec:orgeba3e80}
\lstset{language=Python,label= ,caption={\_\(_{\text{init}}\)\_\(_{\text{.py}}\)},captionpos=b,numbers=none}
\begin{lstlisting}
from enum import Enum, auto
