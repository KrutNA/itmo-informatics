...
#+NAME: fromTenToN
#+CAPTION: fromTenToN
#+BEGIN_SRC python: :exports none :var value=0 :var dim=2
  result = ""
...
#+NAME: fromNToTen 
#+CAPTION: fromNToTen
#+BEGIN_SRC python: :exports none :noweb yes :var value=0 :var dim=2 :var size_b=2 :results output
  def convert():
...
#+CAPTION: zeroFill
#+BEGIN_SRC python: :exports none :var value=0 :var size_b=2  :results output
  result = str(value)
  while size_b*8 > len(result):
      result = "0" + result
  print(result)
...
#+NAME: summ
#+CAPTION: summ
#+BEGIN_SRC python: :exports none :var first=0 :var second=0 :var size_b=2 :results output
